...
public record Vector3D(double X, double Y, double Z)
{
    ...
    // Traditional operator overloading (simulating what would be in C# 14 extension blocks)
...
public static class Vector3DGeometry
{
    extension (Vector3D vector)
    {
        ...
        {
            var dot = Vector3DMathOperators.DotProduct(vector, other);
        ...
        public Vector3D ProjectOnto(Vector3D other)
        {
            ...
            var scale = Vector3DMathOperators.DotProduct(vector, other) / otherMagnitudeSquared;
            return other * scale;
        }
        ...
        public Vector3D Reflect(Vector3D normal)
        {
            ...
            var dot = Vector3DMathOperators.DotProduct(vector, normalizedNormal);
