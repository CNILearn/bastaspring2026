...
public class AdvancedCachingDataSourceGeneratorTests
{
    [Fact]
    public void Generator_WithBasicClass_GeneratesCode()
    {
        var source = """
            using Stage4.AdvancedCaching.Attributes;
        ...
        Assert.Contains("Stage 4: Advanced Caching", generatedSource);
    ...
    [Fact]
    public async Task MultiLevelCacheManager_StoresAndRetrievesValues()
    {
    ...
    {
        var engine = new ChangeDetectionEngine();
