...
namespace Stage4.AdvancedCaching.Sample;
...
public class Program
{
    ...
    {
        Console.WriteLine("=== Stage 4: Advanced Caching Data Source Generator Demo ===");
        Console.WriteLine();
        ...
        Console.WriteLine("=== Advanced Caching Statistics ===");
