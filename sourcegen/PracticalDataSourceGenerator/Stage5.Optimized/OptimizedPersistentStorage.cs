...
/// <summary>
/// Optimized persistent storage with production-ready performance characteristics
/// Simulated for source generator constraints, but designed for high-throughput scenarios
/// </summary>
internal class OptimizedPersistentStorage(string? cacheDirectory = null, string schemaVersion = "1.0")
{
    ...
    private readonly string _cacheDirectory = cacheDirectory ?? "default-cache";
