...
/// <summary>
/// Optimized change detection engine with zero-allocation hash computations and concurrent access patterns
/// Designed for high-performance scenarios with minimal memory overhead
/// </summary>
internal class OptimizedChangeDetectionEngine
{
    // Use concurrent collections for thread-safe access patterns
    private readonly ConcurrentDictionary<string, int> _contentHashes = [];
    private readonly ConcurrentDictionary<string, HashSet<string>> _dependencyGraph = [];
    private readonly ConcurrentDictionary<string, object> _externalDependencies = [];
